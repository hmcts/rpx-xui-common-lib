...
import { checkboxesBeCheckedValidator, dateValidator } from 'projects/exui-common-lib/src/lib/gov-ui/validators';
...
export class StyleGuideComponent implements OnInit {
  ...
  constructor(private readonly store: Store<fromStore.UserState>, private fb: FormBuilder) { }
